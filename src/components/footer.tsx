      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Authentic Vietnamese cuisine in the heart of Mühldorf am Inn.
              Experience the rich flavors and warm hospitality of Vietnam.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-manrope font-semibold text-lg mb-4 text-foreground">
              Quick Links
            </h4>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            ...
            <span className="ml-1">
              Authentic Vietnamese Restaurant in Bavaria
            </span>
          </p>
        </div>
      </div>
